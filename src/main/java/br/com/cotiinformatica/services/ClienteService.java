...
&& clientePorCpf.getIdCliente() != cliente.getIdCliente())throw new IllegalArgumentException("O CPF informado já está cadastrado para outro cliente. Tente outro.");
...
("O Email informado já está cadastrado para outro cliente. Tente outro.");
